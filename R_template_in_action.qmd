...
subtitle: "Advanced Topics in Music Psychology"
...
format: 
  revealjs:
    ...
    footer: "ATMP - R data carpenty - Tuomas Eerola"
...
- Your experience with R or similar? 

- Your datasets (sources, experiments, surveys, etc.)?

- Why is transparent research valuable?

- Do you have `RStudio` and `R_template`?
...
- Basic understanding of _RStudio_ workspace, path, and environment (Chapter 6 in _Music and Science_) 
...
* Reminder of the transparency principles

  * We use a workflow where each stage is **replicable**

  * We **avoid** editing original data manually
  
  * We **document** our operations 
  
  * We favour **common** approaches (i.e. libraries, methods)
  
  * We are willing to **share** (PG, supervisor, collaborator, ...)
...
* There are 23,036 of these in [CRAN](https://cran.r-project.org)
...
* utilise `readxl` library (this comes with `tidyverse` and then run:
