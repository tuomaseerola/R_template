...
```
### TASK: Are we clear what read_data_survey.R is doing?
...
And if you have the data in an Excel file, you can either convert these into CSV or TSV or utilise `readxl` library and then run `v <- read_excel('my_data.xlsx')`.

This should retrieve a data frame into a variable called `v` in _R_, which contains a complex data frame.

## TASK: What is the structure of the data at this point?
...
And how can we easily check the structure, learn about the structures?

* What variables we have? 
* Variables in columns and their structures?
* What about the column names?

</div>

Useful commands: `head`, `str`, `is.na`, `View`.
</p>
